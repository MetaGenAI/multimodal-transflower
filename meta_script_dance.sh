...
for exp in mowgli_expmap3_chunking_stage2
...
do
	...
	sbatch slurm_script4s.slurm $exp --hparams_file=training/hparams/dance_combined/${exp}.yaml --experiment_name ${exp}_newdata_filtered_aistpp2 --num_nodes 1 --max_epochs 3000 --data_dir=$SCRATCH/data/dance_combined3 --base_filenames_file base_filenames_train_filtered3.txt --continue_train --load_weights_only --no_load_hparams
	#sbatch slurm_script4s.slurm $exp --hparams_file=training/hparams/dance_combined/${exp}.yaml --experiment_name ${exp}_newdata_filtered_aistpp2 --num_nodes 1 --max_epochs 3000 --data_dir=$SCRATCH/data/dance_combined3 --base_filenames_file base_filenames_train_filtered3.txt --continue_train
...
#	sbatch slurm_script4s.slurm $exp --experiment_name ${exp}_newdata_filtered_lr2_sm --num_nodes 1 --max_epochs 300 --data_dir=$SCRATCH/data/dance_combined3 --base_filenames_file base_filenames_train_filtered9.txt --learning_rate 5e-4 --continue_train
	...
	#sbatch slurm_script4s.slurm $exp --experiment_name ${exp}_newdata_filtered_gc10_lr1 --num_nodes 1 --max_epochs 300 --data_dir=$SCRATCH/data/dance_combined3 --base_filenames_file base_filenames_train_filtered2.txt --gradient_clip_val 50.0 --learning_rate 1e-6 --continue_train --load_weights_only --no_load_hparams --load_optimizer_states --lr_policy none --hparams_file=training/hparams/dance_combined/${exp}.yaml
