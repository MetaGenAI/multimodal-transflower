...
#./script_train_new.sh $exp --hparams_file=training/hparams/edf_gestures/${exp}.yaml --experiment_name ${exp}_edf_gestures3 --num_nodes 1 --max_epochs 6000 --data_dir=./data/edf_extracted_data_rel/ --base_filenames_file base_filenames.txt ${@:2}
./script_train_new.sh $exp --hparams_file=training/hparams/genea/${exp}.yaml --experiment_name ${exp}_genea1 --num_nodes 1 --max_epochs 6000 --data_dir=./data/genea_sample/ --base_filenames_file base_filenames.txt ${@:2}
