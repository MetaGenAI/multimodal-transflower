...
#sbatch slurm_script_generate.slurm $exp $line --data_dir $SCRATCH/data/kulzaworld_guille_neosdata_npy_relative --sequence_length 2048 --use_temperature --temperature 0.1
