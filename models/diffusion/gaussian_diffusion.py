...
from models.diffusion.losses import discretized_gaussian_log_likelihood, normal_kl
...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps, scale_betas=1.0):
    ...
    """
    # scale_betas = 1/50 #TODO: remove this line when starting to train again!
    if schedule_name == "linear":
        # Linear schedule from Ho et al, extended to work for any number of
        # diffusion steps.
        # scale = scale_betas * 1000 / num_diffusion_timesteps
        scale = scale_betas * 50 / num_diffusion_timesteps
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        #TODO: maybe re-support inpainting
        # if model_kwargs is not None:
        #     if (
