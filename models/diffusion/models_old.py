...
class LabelEmbedder(nn.Module):
    ...
    """
    def __init__(self, n_classes, hidden_size, dropout_prob):
        super().__init__()
        use_cfg_embedding = dropout_prob > 0
        self.n_classes = n_classes
        self.dropout_prob = dropout_prob
        self.embedding_table = nn.Embedding(n_classes + use_cfg_embedding, hidden_size)
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.out_channels = input_channels * 2 if sigma_learning else input_channels
        ...
        self.blocks = nn.ModuleList([
            DiTBlock(hidden_dim, attention_heads, mlp_ratio=mlp_ratio) for _ in range(layers)
        ])
        self.final_layer = FinalLayer(hidden_dim, patch_dim, self.out_channels)
    ...
    def initialize_weights(self):
        ...
        # print(self.x_embedder.num_patches)
