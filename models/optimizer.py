...
def get_scheduler(optimizer, opt, info={}):
    ...
    if opt.lr_policy == 'lambda':
        ...
        scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=opt.lr_decay_factor, threshold=opt.lr_plateau_threshold, patience=opt.lr_plateau_patience, verbose=True, min_lr=opt.plateau_min_lr)
