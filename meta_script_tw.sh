...
do
	...
	#sbatch slurm_script4s.slurm $exp --experiment_name ${exp}_tw_single_more_filtered --hparams_file=training/hparams/tw/${exp}.yaml --num_nodes 1 --max_epochs 6000 --data_dir=$SCRATCH/data/UR5_processed --base_filenames_file base_filenames_single_objs_more_filtered.txt
